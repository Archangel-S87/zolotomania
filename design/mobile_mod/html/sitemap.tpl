...
<div class="page-pg">
	...
	{if $articles}
    <div class="pages">
	<strong><a href="articles" title="Статьи">Статьи</a>:</strong>
        <ul>
	...
	<div class="pages">
		<strong><a href="services" title="Услуги">Услуги</a>:</strong>
