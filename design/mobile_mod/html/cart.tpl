            ...
            {/if}
                ...
                <div class="flex button-block">
                    <div class="row" style="justify-content: space-between">
                        <button id="bring_me" class="button{if $purchase_method =='bring_me'} active{/if}" style="width: 48%; font-size: 14px;" >Доставьте мне</button>
                        <button id="i_pickup" class="button{if $purchase_method =='i_pickup'} active{/if}" style="width: 48%;font-size: 14px;">Заберу в
                            магазине
                        </button>
                    </div>
                    <input id="purchase_method"
                            ...
                            {foreach from=$users_address_list key=hash item=$address}
                                <li style="display: flex">
                                    <label for="address_{$hash}" style="margin-left: 10px; margin-bottom: 20px;">
                                            <span class="checkbox">
                                                <input id="address_{$hash}" type="radio" name="user_address"
                                                       value="{$address}"/>
                                            </span>
