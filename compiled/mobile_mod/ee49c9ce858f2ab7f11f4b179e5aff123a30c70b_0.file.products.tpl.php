...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5f9ffba616fd78_29097624',
...
function content_5f9ffba616fd78_29097624 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
			...
			<li class="product <?php if (!empty($_smarty_tpl->tpl_vars['settings']->value->show_cart_wishcomp)) {?>visible_button<?php }?>"> <div class="labelsblock">
					<?php if (!empty($_smarty_tpl->tpl_vars['product']->value->featured)) {?>
						<svg class="hit"><use xlink:href='#hit' /></svg>
					<?php }?>
					<?php if (!empty($_smarty_tpl->tpl_vars['product']->value->is_new)) {?>
						<svg class="new"><use xlink:href='#new' /></svg>
					<?php }?>
					<?php if (!empty($_smarty_tpl->tpl_vars['product']->value->variant->compare_price)) {?>
						<svg class="lowprice"><use xlink:href='#lowprice' /></svg>
					<?php }?>
				</div> <div class="image qwbox" onclick="window.location='products/<?php echo $_smarty_tpl->tpl_vars['product']->value->url;?>
'">
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
						...
						<?php }?>
						<div class="ratecomp" id="product_<?php echo $_smarty_tpl->tpl_vars['product']->value->id;?>
"> <div class="statVal catrater"> <span class="rater_sm"> <span class="rater-starsOff_sm" style="width:60px;"> <span class="rater-starsOn_sm" style="width:<?php echo $_smarty_tpl->tpl_vars['prod_rating']->value*60/sprintf("%.0f",5);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
							</span> <input id="vhidden" name="variant" value="" type="hidden" /> <div style="display: table; margin-bottom: 5px; height: 20px;"> <select class="p0"<?php if ($_smarty_tpl->tpl_vars['cntname1']->value == 0) {?> style="display:none;"<?php }?>>
									<?php
...
echo $_smarty_tpl->tpl_vars['settings']->value->units;
						...
						<?php } else { ?>
							...
							<select class="b1c_option" name="variant" <?php if (count($_smarty_tpl->tpl_vars['product']->value->variants) == 1 && !$_smarty_tpl->tpl_vars['product']->value->variant->name) {?>style='display:none;'<?php }?>>
								<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['product']->value->variants, 'v');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['v']->value) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
								...
								<?php if (!empty($_smarty_tpl->tpl_vars['settings']->value->show_cart_wishcomp)) {?>
								<span class="amount_wrap"> <input size="2" name="amount" min="1" type="number" value="1">&nbsp;x&nbsp;
								</span>
								<?php }?>
...
echo $_smarty_tpl->tpl_vars['settings']->value->units;
						...
						<?php }?>
							<?php if (!empty($_smarty_tpl->tpl_vars['settings']->value->show_cart_wishcomp)) {?>
								<div class="sub_wishcomp_wrap"> <input type="submit" class="buttonred" value="в корзину" data-result-text="добавлено"/>
